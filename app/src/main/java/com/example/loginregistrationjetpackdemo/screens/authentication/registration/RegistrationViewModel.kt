...
import com.example.loginregistrationjetpackdemo.screens.authentication.registration.state.RegistrationErrorState
import com.example.loginregistrationjetpackdemo.screens.authentication.registration.state.RegistrationState
import com.example.loginregistrationjetpackdemo.screens.authentication.registration.state.confirmPasswordEmptyErrorState
import com.example.loginregistrationjetpackdemo.screens.authentication.registration.state.emailEmptyErrorState
import com.example.loginregistrationjetpackdemo.screens.authentication.registration.state.mobileNumberEmptyErrorState
import com.example.loginregistrationjetpackdemo.screens.authentication.registration.state.passwordEmptyErrorState
import com.example.loginregistrationjetpackdemo.screens.authentication.registration.state.passwordMismatchErrorState
